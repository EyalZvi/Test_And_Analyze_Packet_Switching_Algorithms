...
import sys
from Topo2_test_functions import *
...
def MyNetwork():
    ...
    c5 = net.addHost('c5', cls=Host, ip='10.0.0.5', defaultRoute=None, cpu=0.2)
    c6 = net.addHost('c6', cls=Host, ip='10.0.0.6', defaultRoute=None, cpu=0.2)
    ...
    net.addLink(c4, s1, bw=1)
    net.addLink(c5, s1, bw=1)
    net.addLink(c6, s1, bw=1)
